...
# Subscription Card Verification Method

The method used for card verification.

## Enumeration

`SubscriptionCardVerificationMethod`
...
subscription_card_verification_method = SubscriptionCardVerificationMethod.ENUM_3D_SECURE
```
