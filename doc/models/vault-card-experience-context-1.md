...
```python
from paypalserversdk.models.vault_card_experience_context_1 import VaultCardExperienceContext1
...
vault_card_experience_context_1 = VaultCardExperienceContext1(
