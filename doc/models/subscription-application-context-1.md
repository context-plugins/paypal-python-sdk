...
# Subscription Application Context 1

The application context, which customizes the payer experience during the subscription approval process with PayPal.

## Structure

`SubscriptionApplicationContext1`
...
from paypalserversdk.models.subscription_application_context_1 import SubscriptionApplicationContext1

subscription_application_context_1 = SubscriptionApplicationContext1(
