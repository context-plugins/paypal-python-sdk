...
# Subscription Patch Application Context 1

The application context, which customizes the payer experience during the subscription approval process with PayPal.

## Structure

`SubscriptionPatchApplicationContext1`
...
from paypalserversdk.models.subscription_patch_application_context_1 import SubscriptionPatchApplicationContext1

subscription_patch_application_context_1 = SubscriptionPatchApplicationContext1(
