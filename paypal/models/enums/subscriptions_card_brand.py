...
class SubscriptionsCardBrand(str, Enum):
...
SubscriptionsCardBrandOrStr: TypeAlias = Annotated[
    SubscriptionsCardBrand | str, open_enum_validator(SubscriptionsCardBrand)
]
