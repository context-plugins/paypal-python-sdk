...
class PayPalWalletVaultStatus(str, Enum):
    """The vault status."""
...
PayPalWalletVaultStatusOrStr: TypeAlias = Annotated[
    PayPalWalletVaultStatus | str, open_enum_validator(PayPalWalletVaultStatus)
]
