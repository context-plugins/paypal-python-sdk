...
class OrderApplicationContextShippingPreference(str, Enum):
...
OrderApplicationContextShippingPreferenceOrStr: TypeAlias = Annotated[
    OrderApplicationContextShippingPreference | str, open_enum_validator(OrderApplicationContextShippingPreference)
]
