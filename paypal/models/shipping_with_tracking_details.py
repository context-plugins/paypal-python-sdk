...
class ShippingWithTrackingDetails(SdkBaseModel):
    trackers: Optional[list[OrderTrackerResponse]] = UNSET
    ...
    phone_number: Optional[PhoneNumberWithOptionalCountryCode] = UNSET
    ...
    options: Optional[list[ShippingOption]] = UNSET
