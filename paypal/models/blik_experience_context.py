...
class BlikExperienceContext(SdkBaseModel):
    ...
    consumer_ip: Optional[str] = UNSET
...
class BlikExperienceContextDict(TypedDict):
    ...
    consumer_ip: NotRequired[str]
    consumer_user_agent: NotRequired[str]
